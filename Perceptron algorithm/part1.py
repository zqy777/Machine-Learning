...
def online_Perception(x_train,y_train,x_val,y_val,iters=15):
    ...
    for iter in range(1,iters+1):
        ...
        train_accuracy=get_accurancy(x_train,y_train,w)
        acc_train.append(train_accuracy)
        val_accuracy=get_accurancy(x_val,y_val,w)
    ...
    return acc_train, acc_val, wlist, iters
...
if __name__=='__main__':
    ...
    acc_train, acc_val, wlist,iters=online_Perception(x_train,y_train,x_val,y_val)
    ...
    np.savetxt('oplabel.csv',y_text,delimiter=',')
